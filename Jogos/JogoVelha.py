# ____--Variaveis globais--____
game_still_going = True
current_player = "X"
winner = None

# Definindo o escopo do jogo
board = ["-", "-", "-",
         "-", "-", "-",
         "-", "-", "-"]
...
# Mostrando mensagem e turno para cada jogador
def handle_turn(player):
    print(player + " Sua vez...")
    position = input("Escolha uma posicao entre 1-9: ")
    valid = False
    while not valid:

        while position not in ["1", "2", "3", "4", "5", "6", "7", "8", "9"]:
            position = input("Entrada invalida... Escolha uma posicao entre 1-9: ")
